...
/****** Object:  View [dbo].[V_Final_Degree_Valuation_A]    Script Date: 6/2/2026 1:39:00 AM ******/
SET ANSI_NULLS ON
GO
...
dbo.get_Prim_1_2_3_Evaluation_Final(ROUND((ar_B+math_B+english_B + dain_B)/8,0)
,absent_term_B) as 'term_B_Eval',
...
dbo.get_Prim_Evaluation_Term_B(ar_B,arbic_test_B, absent_ar_B) as 'arabic_B_Grade3_Eval',
dbo.get_Prim_Evaluation_Term_B(math_B,math_test_B, absent_math_B) as 'math_B_Grade3_Eval',
dbo.get_Prim_Evaluation_Term_B(scince_B,scince_test_B, absent_scince_B) as 'motadad_B_Grade3_Eval',
dbo.get_Prim_Evaluation_Term_B(english_B,english_test_B, absent_english_B) as 'english_B_Grade3_Eval',
dbo.get_Prim_Term_A_Evaluation(maharat_B, absent_maharat_B) as 'maharat_B_Grade3_Eval',
dbo.get_Prim_Evaluation_Term_B(dain_B,dain_test_B, absent_din_B) as 'dain_B_Grade3_Eval',
dbo.get_Prim_Grade3_Evaluation_Final(ROUND(total_B_Grade_3/8,0)
,arbic_test_B,math_test_B,scince_test_B,english_test_B, dain_test_B,absent_term_B) as 'term_B_Grade3_Eval',

dbo.get_Prim_Pass_Term_B(ar_B,arbic_test_B, absent_ar_B) as 'pass_ar_B_Grade3',
dbo.get_Prim_Pass_Term_B(math_B,math_test_B, absent_math_B) as 'pass_math_B_Grade3',
dbo.get_Prim_Pass_Term_B(scince_B,scince_test_B, absent_scince_B) as 'pass_motadad_B_Grade3',
dbo.get_Prim_Pass_Term_B(english_B,english_test_B, absent_english_B) as 'pass_english_B_Grade3',
dbo.get_Prim_Pass_Term_B(dain_B,dain_test_B, absent_din_B) as 'pass_dain_B_Grade3',
...
1,
absent_term_B)as 'pass_term_B_Grade3'
